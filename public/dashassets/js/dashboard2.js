$(function () {
  ...
  new ApexCharts(document.querySelector("#monthly-earning1"), options).render();
  ...
  new ApexCharts(document.querySelector("#monthly-earning2"), options).render();
  ...
  new ApexCharts(document.querySelector("#monthly-earning3"), options).render();
