...
@endif
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Form Template</h4>
                ...
                {!! Form::hidden('customer_id', $groups->id, array('placeholder' => 'Name','class' => 'form-control')) !!}
                <div class="table-responsive-lg Coverages_tabless">
                    <table class="table table-bordered">
                        ...
                        @foreach($customFields as $cus)
                            <tr>
                                <td colspan="4">
                                    <strong class="section_heads"> {{$cus->name}}</strong>
                                </td>
                            </tr>
                            @if($cus->customField)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center template_box_action">
                                        <button class="btn copy" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalcoveragesection"><i class="fas fa-plus"></i></button>
                                    </div>
