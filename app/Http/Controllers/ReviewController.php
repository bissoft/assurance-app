...
{ 
    ...
    {   
        $customer=Business::find($request->customer_id);
        
        CustomField::saveData($customer, $request->customField);
    
        return redirect()->back()
                        ->with('success','Review Save successfully.');
    }
    ...
    { 
        ...
        $customFields->customField = CustomField::getData($groups, $id);
        
        $types   = CustomField::$fieldTypes;
        $modules = Business::all();
              
        return view('reviews.show',compact('groups','id','customFields','types','modules'));
    }
